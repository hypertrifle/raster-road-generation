...
class RoadGenerationComponent extends Component {
    ...
    function renderSegment(segmentIn:Segment, width:Float, index:Int){
    	...
    	geomerty.roadPoly.color = (Math.floor(segmentIn.index/rumbleLength)%2 == 0) ? new Color().rgb(0xff4b03) : new Color().rgb(0xee4b03);
    	geomerty.backgroundPoly.color = (Math.floor(segmentIn.index/rumbleLength)%2 == 0) ? new Color().rgb(0x21a01b) : new Color().rgb(0x21801b);
